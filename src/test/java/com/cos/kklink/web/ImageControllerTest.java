...
public class ImageControllerTest {
	...
	public void 회원가입() throws Exception {
		...
		JoinReqDto user = JoinReqDto.builder().username(username).password(password).email(email).name(name).build();
		...
		mvc.perform(post(url).contentType(MediaType.APPLICATION_FORM_URLENCODED).content(formData.toString()))
